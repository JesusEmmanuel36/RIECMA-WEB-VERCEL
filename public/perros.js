        ...
        .then(data => {
            ...
            if (id) {
                ...
                fetch("/api/perros")
                    ...
                    .then(perrosArray => {
                        const perroEncontrado = perrosArray.find(g => g._id === id);
                        ...
                        if (perroEncontrado) {
                            ...
                            ImagenAnimal.src = perroEncontrado.IMAGEN
                            NombreMascota.textContent = (perroEncontrado.NOMBRE).toUpperCase() + " (" + (perroEncontrado.GENERO).toUpperCase() + ")"
                            EdadMascota.textContent = (perroEncontrado.EDAD).toUpperCase()
                            TallaMascota.textContent = (perroEncontrado.TALLA).toUpperCase()
                            PersonalidadMascota.textContent = perroEncontrado.PERSONALIDAD
                            HistoriaMascota.textContent = perroEncontrado.HISTORIA
                            ...
                            fetch("/api/perros")
                                ...
                                .then(perrosArray => {
                                    ...
                                    perrosArray.forEach(perro => {
                                        const mascota = {
                                            id: perro._id,
                                            imagen: perro.IMAGEN,
                                            nombre: (perro.NOMBRE).toUpperCase() + " (" + (perro.GENERO).toUpperCase() + ")",
                                            descripcion: perro.PERSONALIDAD,
                                            edad: perro.EDAD,
                                            talla: perro.TALLA
                                        };
                                        ...
                                        btn.addEventListener("click", () => {
                                            window.location.href = "/perros?id=" + mascota.id
                                        })
